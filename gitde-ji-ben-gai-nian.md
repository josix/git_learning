...
通常提交物件會使用雜湊值來記錄一個提交物件，如1ebea8dae4a2a02c62c195445c34d2b0f1a0bf73指向一個特定的提交物件。而標籤物件就是用來給特定物件一個名稱，如給予剛剛所指向的提交物件名稱為My-First-Commit，則讓人更容易辨識。另外標籤物件不限定只給予提交物件名稱，其他物件也都適用。
